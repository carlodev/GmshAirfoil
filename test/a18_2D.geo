...
Point(50) = {0, 0, 0};
Point(51) = { Refinement_offset*Sin(AoA),  Refinement_offset*Cos(AoA), 0};
Point(52) = { - Refinement_offset*Sin(AoA),  - Refinement_offset*Cos(AoA), 0};
Point(53) = {1*Cos(AoA), -1* 1.0*Sin(AoA) + 0.00614*1*Cos(AoA) + Refinement_offset, 0};
Point(54) = {L, -L* 1.0*Sin(AoA) + 0.00614*L*Cos(AoA)+ Refinement_offset, 0};
Point(55) = {L, -L* 1.0*Sin(AoA) + 0.0*L*Cos(AoA) - Refinement_offset, 0};
Point(56) = {1*Cos(AoA), -1* 1.0*Sin(AoA) + 0.0*1*Cos(AoA) - Refinement_offset, 0};
Circle(5) = {43, 50, 42};
Line(6) = {42, 46};
Line(7) = {43, 47};
Line(8) = {46, 44};
...
Curve Loop(7) = {25,9,-1,-13 };
Curve Loop(8) = {26,10,2,-15 };
Curve Loop(9) = {27,17,23,-9 };
Curve Loop(10) = {28,-19,21,-10 };
Plane Surface(1) = {1};
Plane Surface(2) = {2};
Plane Surface(3) = {3};
Plane Surface(4) = {4};
...
Physical Point ("airfoil", 6) = {25, 17, 41}; 
Physical Point ("limits", 7) = {42, 43, 46, 47, 44, 45}; 
Physical Point ("outlet", 8) = {48, 54, 55}; 
Physical Curve ("airfoil", 2) += {3}; 
Physical Curve ("outlet", 4) += {18, 19}; 
Physical Point ("airfoil", 6) += {1}; 
Physical Point ("outlet", 8) += {49}; 
