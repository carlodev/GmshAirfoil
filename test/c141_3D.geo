...
Physical Volume("fluid", 100) = {1:11}; 
 Physical Surface("zm", 101) = {1:11}; 
Physical Point ("outlet", 1) = {79, 72, 73, 78, 92, 90, 97, 98}; 
Physical Point ("limits", 2) = {67, 71, 69, 66, 70, 68, 84, 87, 91, 81, 85, 89}; 
Physical Point ("airfoil", 3) = {93, 94, 95, 96}; 
Physical Curve ("airfoil", 4) = {1, 2, 3, 4, 60, 58, 66, 63, 61, 65, 68, 76}; 
Physical Curve ("inlet", 5) = {5, 37}; 
Physical Curve ("limits", 6) = {6, 7, 8, 11, 30, 38, 48, 35, 43, 53, 44, 54, 39, 49}; 
Physical Curve ("outlet", 7) = {16, 17, 18, 19, 20, 55, 72, 69, 50, 56, 73, 75, 70, 51}; 
