...
Physical Point ("outlet", 1) = {66, 72, 71, 85, 89, 83}; 
Physical Point ("limits", 2) = {61, 65, 63, 77, 80, 143, 60, 64, 62, 74, 78, 82}; 
Physical Point ("airfoil", 3) = {86, 87, 88}; 
Physical Curve ("airfoil", 4) = {1, 2, 3, 58, 62, 64, 57, 55, 60}; 
Physical Curve ("inlet", 5) = {4, 34}; 
Physical Curve ("limits", 6) = {27, 35, 45, 32, 40, 50, 5, 7, 36, 46, 41, 51}; 
