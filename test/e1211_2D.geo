...
Point(67) = {0, 0, 0};
Point(68) = { Refinement_offset*Sin(AoA),  Refinement_offset*Cos(AoA), 0};
Point(69) = { - Refinement_offset*Sin(AoA),  - Refinement_offset*Cos(AoA), 0};
Point(70) = {1*Cos(AoA), -1* 1.0*Sin(AoA) + -0.0*1*Cos(AoA) + Refinement_offset, 0};
Point(71) = {L, -L* 1.0*Sin(AoA) + -0.0*L*Cos(AoA)+ Refinement_offset, 0};
Point(72) = {L, -L* 1.0*Sin(AoA) + -0.0*L*Cos(AoA) - Refinement_offset, 0};
Point(73) = {1*Cos(AoA), -1* 1.0*Sin(AoA) + -0.0*1*Cos(AoA) - Refinement_offset, 0};
Circle(4) = {61, 67, 60};
Line(5) = {60, 64};
Line(6) = {61, 65};
Line(7) = {64, 62};
...
Physical Point ("airfoil", 6) = {34, 24, 1}; 
Physical Point ("limits", 7) = {60, 61, 64, 65, 62, 63}; 
Physical Point ("outlet", 8) = {66, 71, 72}; 
